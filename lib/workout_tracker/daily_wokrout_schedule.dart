...
import 'package:masmas_fit/dashboard/activity_tracker.dart';
...
class CheckDailyWorkoutScheduleCard extends StatelessWidget {
  const CheckDailyWorkoutScheduleCard({Key? key}) : super(key: key);
